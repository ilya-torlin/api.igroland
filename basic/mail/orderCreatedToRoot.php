                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"> <?php echo $bath['title'];?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>                                                
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"> <?php echo $bath['address'];?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    <td style="color: #2f3850; width: 25px; background-color: #fff"
                                                                        valign="middle" align="center">
                                                                        <img src="http://praweb.ru/email-image/phone.png" alt="ip"/>
                                                                    </td>
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; width:130px; background-color: #fff">
                                                                        Телефон: 
                                                                    </td>
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"> <?php echo $bath['phone'];?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                        ...
                        <table align="center" valign="middle" >
                            <tr>
                                <td valign="middle" align="center" style="height: 45px">
                                    <a href="http://praweb.ru"><img src="http://praweb.ru/email-image/logo.png" alt="PraWeb"/></a>
                                </td>
                                <td valign="middle" align="center" style="height: 45px;color: #2f3850;">
                                    - ВАШ ЭКСПЕРТ В ПРОДВИЖЕНИИ САЙТОВ
                                </td>
                            </tr>
                        </table>
                    </td>
