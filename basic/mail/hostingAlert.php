                                                ...
                                                <table style="width: 100%; height: 100%; padding-top: 15px"
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="color: #2f3850; text-decoration: underline;" valign="top">
                                                            Подходит срок окончания оплаченного хостинга по проекту <?php echo $project->name;?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"><a href="https://hosting.timeweb.ru/login">timeweb</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold;  color: #2f3850; padding-left: 10px"><?php echo $project->hosting_login;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold;  color: #2f3850; padding-left: 10px"><?php echo $project->hosting_pass;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"> <?php echo $expdays;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
