                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; color: #2f3850; padding-left: 10px"> <?php echo $email;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr> 
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; color: #2f3850; padding-left: 10px"> <?php echo $pass;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr> 
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; color: #2f3850; padding-left: 10px"><a href="<?php echo $link;?>">Перейдите по ссылке для смены пароля</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>  
