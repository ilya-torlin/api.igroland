                                                ...
                                                <table style="width: 100%; height: 100%; padding-top: 15px"
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="color: #2f3850; text-decoration: underline;" valign="top">
                                                            Подходит срок окончания регистрации домена по проекту <?php echo $project->name;?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                                                        ...
                                                        <td style="padding: 4px 0">
                                                            <table cellspacing="0"
                                                                ...
                                                                <tr style="height: 25px">
                                                                    ...
                                                                    <td style="font-weight: bold; text-transform: uppercase; color: #2f3850; padding-left: 10px"><?php echo $project->url;?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
